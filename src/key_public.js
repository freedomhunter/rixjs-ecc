...
/**
  ...
  @param {string} [pubkey_prefix = 'RIX']
*/
function PublicKey(Q, pubkey_prefix = 'RIX') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'RIX'] - public key prefix
    */
    function toString(pubkey_prefix = 'RIX') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'RIX']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'RIX') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'RIX') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'RIX') {
