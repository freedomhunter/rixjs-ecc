...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // RIXkey...
})
    */
    ...
    */
    privateToPublic: (wif, pubkey_prefix = 'RIX') =>
      PrivateKey(wif).toPublic().toString(pubkey_prefix),

    /**
        @arg {pubkey} pubkey - like RIXKey..
        @arg {string} [pubkey_prefix = 'RIX']

        @return {boolean} valid

        @example ecc.isValidPublic(pubkey) === true
    */
    isValidPublic: (pubkey, pubkey_prefix = 'RIX') =>
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (RIXbase58sig.., Hex, Buffer)
